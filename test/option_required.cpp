...
TEST(option_required, required_success) {
	struct_mapping::MemberString<Enum_required_success>::set([] (const std::string & value) {
		if (value == "v1") return Enum_required_success::v1;
		if (value == "v2") return Enum_required_success::v2;
		if (value == "v3") return Enum_required_success::v3;
	...
	struct_mapping::reg(&Struct_required_success::member_unsigned_char, "member_unsigned_char", struct_mapping::Required{});
	struct_mapping::reg(&Struct_required_success::member_short, "member_short", struct_mapping::Required{});
	struct_mapping::reg(&Struct_required_success::member_unsigned_short, "member_unsigned_short", struct_mapping::Required{});
	struct_mapping::reg(&Struct_required_success::member_int, "member_int", struct_mapping::Required{});
	struct_mapping::reg(&Struct_required_success::member_unsigned_int, "member_unsigned_int", struct_mapping::Required{});
...
TEST(option_required, required_enum) {
	struct_mapping::MemberString<Enum_required>::set([] (const std::string & value) {
		if (value == "v1") return Enum_required::v1;
		if (value == "v2") return Enum_required::v2;
		if (value == "v3") return Enum_required::v3;
